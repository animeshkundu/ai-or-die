...
## Deferrals tracked for follow-up
...
- **~~Agent-vs-user concurrent file edits — proactive sync~~** **— resolved in [ADR-0017](0017-fs-watcher-push-channel.md)**, scoped INTO this PR after team-lead review of the gemini-2/5 + codex-3/5 verdicts. v1 ships the chokidar fs-watcher + SSE push channel + TabManager reactive integration. The hash-based 409-Conflict-on-save flow stays as a backstop. Issue [#100](https://github.com/animeshkundu/ai-or-die/issues/100) closes on merge.
