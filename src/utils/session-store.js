...
const MAX_BUFFER_BYTES_PER_SESSION = CircularBuffer.LIVE_OUTPUT_MAX_BYTES || (512 * 1024);
const METADATA_FALLBACK_MAX_BYTES = 64 * 1024;
// Practical safe-load ceiling: 16 MiB default (hard limit 128 MiB)
// JSON.parse expands into V8 heap objects; keeping the ceiling modest prevents OOM spikes
const DEFAULT_MAX_SAFE_LOAD_BYTES = 16 * 1024 * 1024;
